...
public class SettingsOverlay {
  ...
  public SettingsOverlay(final PiazzaPanicGame game) {
    ...
    TextButton backButton =
        game.getButtonManager().createTextButton("Back", ButtonManager.ButtonColour.GREY);
    ...
    final CheckBox fullscreenCheckbox =
        game.getButtonManager().createCheckbox("Fullscreen", ButtonColour.BLUE);
