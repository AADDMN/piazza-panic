...
public class TutorialOverlay {
  ...
  public TutorialOverlay(final PiazzaPanicGame game) {
    ...
    TextButton backButton =
        game.getButtonManager().createTextButton("Done", ButtonManager.ButtonColour.GREY);
    ...
    TextButton nextButon =
        game.getButtonManager().createTextButton("Next", ButtonManager.ButtonColour.GREY);
    nextButon.addListener(
        new ClickListener() {
          @Override
          public void clicked(InputEvent event, float x, float y) {
            hide();
